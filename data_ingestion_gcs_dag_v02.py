...
dataset_file = dataset_url + "/yellow_tripdata_{{ execution_date.strftime(\"%Y-%m\") }}.csv"
...
with DAG(
    ...
    download_dataset_task = BashOperator(
        ...
        bash_command=f"curl -sS {dataset_file} > {path_to_local_home}/{output_file}"
    )
    ...
    format_to_parquet_task = PythonOperator(
        ...
        op_kwargs={
            "src_file": f"{path_to_local_home}/{output_file}"
        },
    )
